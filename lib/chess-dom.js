...
function enPassantTarget(placement, boardEl) {
  const board = boardEl || document.querySelector('wc-chess-board, chess-board');
  const squares = [];
...
const fenFrom = (placement, board) =>
  `${placement} ${getTurnFromMoveList()} ${castlingFromPlacement(placement)} ` +
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = {
    PIECE_MAP, buildFENFromPieces, placementToMap, castlingFromPlacement,
